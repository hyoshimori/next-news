import * as NewsItemCheckType from "src/assets/types/typeFiles/NewsItemCheckType";
...
export const removeDuplicates = (
  data: NewsItemCheckType.NewsItemCheck[],
  key: keyof NewsItemCheckType.NewsItemCheck
): NewsItemCheckType.NewsItemCheck[] => {
