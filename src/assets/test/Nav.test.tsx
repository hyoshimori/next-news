...
import { Nav } from "src/assets/components/index";
...
describe("# Nav Component", () => {
  ...
  //   console.log(
  //     "# component/Nav:",
  //     `"${title.innerHTML}"'s each first letter needs to be uppercase.`
  //   );
...
//     console.log(
//       "# component/Nav:",
//       "toggle swicth must function with classNames."
//     );
...
//     console.log(
//       "# component/Nav:",
//       "Arrow must hide the category list when the back arrow icon is clicked"
//     );
//     const { getByTestId } = render(<Nav />);
//     const menuIcon = getByTestId("menu-icon");
