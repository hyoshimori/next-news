...
import { ArticleStyles, ErrorMessage, Footer, LoadDetailStyles, LoadingSpinner } from "src/assets/components/index";
import LoadDetail from "../../assets/components/main/timeline/LoadDetail";
import { removeDuplicatesUtility } from "src/assets/utility/index";
import { ViewContext } from "src/pages/_app";
import * as NewsType from "src/assets/types/index";
